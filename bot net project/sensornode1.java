    ...
    File f;
	...
	
	 {
...

	   {
		 ...
		 title=new JLabel("<html><font color=#FFFFFF size=+2><strong>BOT NET ATTACK IN COMPUTER </strong></font>");
		 title1=new JLabel("<html><font color=#FFFFFF size=+2><strong>NETWORK SECURITY </strong></font>");
		 n1=new JLabel("<html><font color=#FFFFFF size=+1><strong>Sensor Node1</strong></font>");
