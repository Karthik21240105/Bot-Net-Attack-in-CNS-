...
public class sensornode2 extends JFrame implements ActionListener
{
    ...
    File f;
	...
	
	 {
...

	   {
		 ...
		 title=new JLabel("<html><font color=#FFFFFF size=+2><strong>BOT NET ATTACK IN  </strong></font>");
		 title1=new JLabel("<html><font color=#FFFFFF size=+2><strong>COMPUTER NETWORK SECURITY </strong></font>");
		 n1=new JLabel("<html><font color=#FFFFFF size=+1><strong>Sensor Node2</strong></font>");
	   ...
	   public void actionPerformed(ActionEvent ae)
		...
		try
		{
		   ...
		   String url = "rmi://127.0.0.1:2001/storagenode";
		...
		System.out.println("File Sending From Sensornode2 to Storagenode");
		System.out.println("\n");	
	    ...
	    {
		new sensornode2();
		System.out.println("Sensornode2 Started....");
		}
		}
